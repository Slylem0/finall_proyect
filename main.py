...
def button2_click():
    ...
    customtkinter.CTkLabel(master=frame, text="Origin",
                           font=("Century Gothic", 15)).place(x=10, y=10)
    customtkinter.CTkLabel(master=frame, text="Origen",
                           font=("Century Gothic", 15)).place(x=10, y=50)
    with open(fr"C:\Users\pnico\Downloads\Datos_Vuelos _Finales.txt",
              "r") as archivo:
...
def first_window():
    ...
    image_path = tkinter.PhotoImage(
        file=(fr"C:\Users\pnico\Downloads\Backgroung.png"))
    ...
    image1 = PhotoImage(
        file=(fr"C:\Users\pnico\Documents" +
              fr"\Finall_proyect\finall_proyect\images\Logo.png"))
